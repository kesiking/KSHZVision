...
- (void)strokeChart
{
    ...
    CALayer *gradientLayerBase = [CALayer layer];
    
    CAGradientLayer *gradientLeftLayer = [CAGradientLayer layer];
    gradientLeftLayer.frame = CGRectMake(0, 0, self.bounds.size.width/2, self.bounds.size.height);
    NSArray *strokeLeftcolors = _strokeLeftColors ? _strokeLeftColors : @[
                                                                          (id)[[UIColor purpleColor] CGColor],
                                                                          (id)[[UIColor blueColor] CGColor],
                                                                          (id)[[UIColor greenColor] CGColor]
                                                                          ];
    [gradientLeftLayer setColors:strokeLeftcolors];
    [gradientLeftLayer setStartPoint:CGPointMake(0.5, 0)];
    [gradientLeftLayer setEndPoint:CGPointMake(0.5, 1)];
    [gradientLayerBase addSublayer:gradientLeftLayer];
    
    CAGradientLayer *gradientRightLayer =  [CAGradientLayer layer];
    gradientRightLayer.frame = CGRectMake(self.bounds.size.width/2 - 4, 0, self.bounds.size.width/2, self.bounds.size.height);
    NSArray *strokeRightcolors = _strokeRightColors ? _strokeRightColors : @[
                                                                             (id)[[UIColor redColor] CGColor],
                                                                             (id)[[UIColor orangeColor] CGColor],
                                                                             (id)[[UIColor greenColor] CGColor]
                                                                             ];
    [gradientRightLayer setColors:strokeRightcolors];
    [gradientRightLayer setStartPoint:CGPointMake(0.5, 0)];
    [gradientRightLayer setEndPoint:CGPointMake(0.5, 1)];
    [gradientLayerBase addSublayer:gradientRightLayer];
    
    [gradientLayerBase setMask:self.gradientMask];
    
    [_circle addSublayer:gradientLayerBase];
