//
//  WeAppTSimpleSelectorScrollView.m
//  WeAppSDK
//
...
@interface WeAppTSimpleSelectorScrollView ()
...
@implementation WeAppTSimpleSelectorScrollView
...
- (void) setupView {
    ...
    self.itemViewClass = [WeAppSelectorButton class];
}
...
-(void)setSelectorProperty:(WeAppBasicMenuItemView*)itemView withIndex:(NSUInteger)index isSelect:(BOOL)isSelect{
    ...
    WeAppSelectorButton *btn = (WeAppSelectorButton*)itemView;
...
-(BOOL)itemViewSelected:(WeAppBasicMenuItemView*)itemView withOldItemView:(WeAppBasicMenuItemView*)oldItemView{
    ...
    WeAppSelectorButton *oldBtn = (WeAppSelectorButton*)oldItemView;
